      ...
      <div className="w-full max-w-sm rounded-2xl bg-light-surface p-8 shadow-lg shadow-black/5 dark:bg-dark-surface dark:shadow-black/40">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full rounded-full bg-accent px-4 py-2 font-semibold text-light-bg transition-colors hover:bg-accentHover active:bg-accentActive disabled:opacity-50"
          >
            Log in
          </button>
        </form>

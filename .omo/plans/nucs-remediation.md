...
- [ ] 2. Add ArtistExternalIdentity + ReleaseExternalIdentity tables + split provenance storage, migration, backfill
...
- [ ] 3. Identity service helpers: find/attach/retrieve/preferred + status derivation
...
- [ ] 4. Migrate artist API to identities[] + Status + mutation endpoints
...
- [ ] 5. Release identity access helpers wired into release creation
...
- [ ] 6. Frontend artist contract: types + Status display groundwork
...
- [ ] 7. Phase 1 gate: schema/migration review + independent review + fix loop + git delivery
...
- [ ] 8. Provider-neutral artist_identity matching service
...
- [ ] 9. Rewire rematch/link/auto-match to identity model
...
- [ ] 10. Artists page: Status + identity management UX
...
- [ ] 11. Metadata regression tests (library derivation rules)
...
- [ ] 12. PiKi-style homonym safety regression
...
- [ ] 13. Phase 2 gate: identity/matching UX review + fix loop + git delivery
...
- [ ] 14. Catalog priority constant + observable fallback reasons
...
- [ ] 15. Identity-driven daily discovery (stop name-search glue)
...
- [ ] 16. Apple-first fallback flow in level-1 discovery
...
- [ ] 17. Conservative canonical release matcher with merge reasons
...
- [ ] 18. Attach provider identity on merge + ReleaseArtist authoritative
...
- [ ] 19. Phase 3 gate: discovery/dedup review + Axwell fixtures + fix loop + git delivery
...
- [ ] 20. SeenRecording semantics: failure vs rejected + fingerprint columns
...
- [ ] 21. Policy fingerprint for eligibility
...
- [ ] 22. Performance instrumentation (scan stats counters)
...
- [ ] 23. Algorithmic waste removal + benchmark (no concurrency yet)
...
- [ ] 24. Phase 4 gate: review + fix loop + git delivery
...
- [ ] 25. Date classification with configured timezone + injectable clock
...
- [ ] 26. Discovery accepts future releases
...
- [ ] 27. Release list API view filter (released|upcoming)
...
- [ ] 28. Feed UI: Released | Upcoming tabs + URL params
...
- [ ] 29. Release detail: Favorite/Hide, no seen for upcoming
...
- [ ] 30. Persisted idempotent two-stage notifications
...
- [ ] 31. Phase 5 gate: Upcoming semantics review + fix loop + git delivery
...
- [ ] 32. Scan task registry with full state
...
- [ ] 33. Discovery (releases/feat) cancellation
...
- [ ] 34. Cooperative library cancellation (worker thread)
...
- [ ] 37. Truthful progress phases (determinate/indeterminate)
...
- [ ] 38. Refresh survival regression
...
- [ ] 39. React Query completion invalidation
...
- [ ] 40. Atomic race-safe Reset Library + new tables
...
- [ ] 41. Phase 6 gate: async lifecycle review + fix loop + git delivery
...
- [ ] 42. Error read state (read_at) + API
...
- [ ] 43. Errors page UX (filters, mark read, expand)
...
- [ ] 44. Diagnostic Markdown report (scrubbed, copyable)
...
- [ ] 45. Login request path (timeout/429) without weakening auth
...
- [ ] 46. Phase 7 gate: diagnostics/security review + fix loop + git delivery
...
- [ ] 48. Artists desktop Status columns
...
- [ ] 49. Artists mobile cards mirror Status
...
- [ ] 50. Robust tracked-artist highlight
...
- [ ] 51. Upcoming tab visual coherence
...
- [ ] 52. Remove old semantics (manual/mbid/MatchCell/Source/MB toasts)
...
- [ ] 53. Phase 8 gate: UI review + fix loop + git delivery
...
- [ ] 54. Backend deterministic regression suites (spec:1628-1716 areas)
...
- [ ] 55. New deterministic remediation e2e scenario fase-16.js
...
- [ ] 56. Supersede fase-15.js removed-behavior assertions
...
- [ ] 57. Migration/security/integration audit + full regression gate
...
- [ ] 59. PiKi homonym live validation
